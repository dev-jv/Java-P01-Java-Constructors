...
public class view_trees {
	...
	public static void main(String[] args) {
		...
		ejemplares[1] = new Trees("Decap", "Tiger Bark", 45, "Banyan", "Hoja", "Green", "Shohin", 4000, false, false, true);
		...
		ejemplares[4] = new Trees("Sa", "Ulmus Parvifolia", 55, "Kenkai", "Hoja", "Green", "Chujin", 56777, true, false, false);
		ejemplares[5] = new Trees("Elle", "Acer Media luna", 33, "Han-Kengai", "Hoja", "Green", "Shohin", 7222, true, false, false);
		
		for(Trees p: ejemplares) {
			System.out.println(p.mosDatos());
		}
	}
}